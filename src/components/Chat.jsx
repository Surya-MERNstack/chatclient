...
const Chat = () => {
  ...
  return (
    <div className="flex h-screen">
      <div className="bg-white w-full sm:w-1/3 md:w-1/4 lg:w-1/5 flex flex-col">
        {/* Sidebar content */}
        <Logo />
        {Object.keys(onlinePeopleEXclOurUSer).map((userId) => (
          <ContactDetails
      ...
      <div className="flex flex-col bg-blue-50 w-full sm:w-2/3 md:w-3/4 lg:w-4/5 p-2">
        {/* Chat content */}
        {!selectUser && (
          <div className="flex h-full flex-grow items-center justify-center">
            <div className="text-gray-400 flex">
              ...
              <div className="absolute top-0 left-0 right-0 bottom-2 overflow-y-scroll">
                {messageWithoutDupes.map((data) => (
                  <div
                    key={data._id}
                    className={
                      data.sender == id ? "text-right" : "text-left"
                    }
                  >
                    <div
                      className={
